...
# Set paths
root_dir = r'E:\Duke_DLDS\Series_Classification\Series_Classification'
csv_path = r'E:\Duke_DLDS\SeriesClassificationKey.csv'
output_folder = r'E:\Duke_DLDS\Aravind\Ensemble_output'
...
class EnsembleModel(nn.Module):
    def _init_(self, models, num_classes):
...
def main():
    ...
    model_names = [ 'resnet50', 'efficientnet_b0']#'densenet121' missing
    models = {}
    best_val_accs = {}
